...
public class CitySpinnerAdapter extends BaseAdapter {
    ...
    ImageView icon;
    private ArrayList<GetCityModelData> modelList;

    public CitySpinnerAdapter(Context applicationContext, int[] flags, ArrayList<GetCityModelData> modelList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
      ...
      countrycode.setText(modelList.get(i).getCityName());
        return view;
